...
LOGIN_TEST_DATA = [('keirahahe', '123', 200, ''),
                   ('keirahahe', 'xyz', 401, 'Wrong password'),
                   ('keira', '123', 401, 'User does not exist'),
                   ('thisauserthatdoesntexist', '12345', 401, 'does not exist'),
                   ('', '12345', 400, 'username cant be empty'),
                   ('thisauserthatdoesntexist', '', 400, 'password cant be empty')]

INVALID_API_METHODS = ['PUT', 'PATCH', 'GET', 'DELETE']
